...
import styles from './postCreate.module.css'; // Импортируем стили
...
const PostCreate = () => {
    ...
    return (
      <div className={styles.main}>
        <div className={styles.postCreate_container}>
            <h3 className={styles.postCreate_heading}>Create Post</h3>
            <input
                className={styles.postCreate_input}
                type="text"
            ...
            />
            <button
                className={styles.postCreate_button}
                onClick={() => dispatch(createPost({ post, navigate }))}
            >
                Create Post
            </button>
        </div>
...
//     <div>
//     <h3>Create Post</h3>
//     <input type="text" placeholder="Company Name" onChange={(e) => setPost({ ...post, companyName: e.target.value })} />
//     <input type="text" placeholder="Vacancy" onChange={(e) => setPost({ ...post, vacancy: e.target.value })} />
...
//     <button onClick={() => dispatch(createPost({ post, navigate }))}>Create Post</button>
//   </div>
//   )
// }
